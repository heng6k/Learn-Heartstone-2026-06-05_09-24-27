...
test('the verified Windows release is downloadable and matches its manifest', () => {
  ...
  assert.equal(windowsManifest.validation.resizableWindow, 'passed-d3d11-d3d12-maximize')
  assert.equal(windowsManifest.validation.remoteReadbackSha256, 'passed-r2-object-get')
  assert.equal(windowsManifest.validation.publicDomainReadback, 'passed-head-and-32m-range-smoke')
