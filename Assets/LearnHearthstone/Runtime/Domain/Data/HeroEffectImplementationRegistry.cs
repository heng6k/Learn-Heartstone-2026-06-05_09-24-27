...
namespace LearnHearthstone.Domain.Data
{
    ...
    public static class HeroEffectImplementationRegistry
    {
        private static readonly HeroEffectImplementation[] Entries =
        {
            ...
            Entry("BG22_HERO_000", "Tavish Stormpike", "BG22_HERO_000p", "BG22_HERO_000_Buddy", "Crabby", "Phase 5", HeroEffectImplementationStatus.FrameworkFirst, "Deadeye target selection, start-of-combat damage/removal, and Crabby plain-copy reward are implemented; full targeting UI polish remains a product follow-up."),
            Entry("BG20_HERO_282", "Tamsin Roame", "BG20_HERO_282p", "BG20_HERO_282_Buddy", "Monstrosity", "Phase 5", HeroEffectImplementationStatus.FrameworkFirst, "Fragrant Phylactery start-of-combat stat-sharing Deathrattle and Monstrosity friendly-death Attack growth are implemented through combat death hooks."),
            ...
            Entry("BG22_HERO_305", "Onyxia", "BG22_HERO_305p", "BG22_HERO_305_Buddy", "Many Whelps", "Phase 5", HeroEffectImplementationStatus.FrameworkFirst, "Broodmother hero-level Avenge summon, immediate Whelp attack queue, and Many Whelps permanent growth are implemented."),
            ...
            Entry("BG22_HERO_001", "Bru'kan", "BG22_HERO_001p", "BG22_HERO_001_Buddy", "Spirit Raptor", "Phase 5", HeroEffectImplementationStatus.FrameworkFirst, "Element choice state, start-of-combat element calls, and Spirit Raptor remembered Deathrattle replay are implemented with local baseline element effects."),
            ...
            Entry("BG20_HERO_283", "Galewing", "BG20_HERO_283p", "BG20_HERO_283_Buddy", "Flight Trainer", "Phase 6", HeroEffectImplementationStatus.FrameworkFirst, "Flightpath pending choice, delayed completion, no-repeat route filtering, and Flight Trainer double trigger are implemented with explicit proxy rewards because local data lacks the three route reward texts."),
            ...
            Entry("TB_BaconShop_HERO_35", "Yogg-Saron, Hope's End", "TB_BaconShop_HP_039t", "TB_BaconShop_HERO_35_Buddy", "Acolyte of Yogg-Saron", "Phase 6", HeroEffectImplementationStatus.FrameworkFirst, "Puzzle Box casts a legal random Tavern spell at start of turn from Turn 3; Acolyte spins a visible Wheel proxy using the shared Yogg reward set until the official Wheel table is added."),
            ...
            Entry("BG34_HERO_004", "Morchie", "BG34_HERO_004p", null, null, "Phase 7", HeroEffectImplementationStatus.FrameworkFirst, "Warped Conflux opens the Minor Timewarped Tavern on Turn 5; no buddy mapping."),
            Entry("BG34_HERO_000", "Murozond, Unbounded", "BG34_HERO_000p", null, null, "Phase 7", HeroEffectImplementationStatus.FrameworkFirst, "Alternate Timeline opens the Major Timewarped Tavern on Turn 8; opponent-history extensions remain deferred."),
