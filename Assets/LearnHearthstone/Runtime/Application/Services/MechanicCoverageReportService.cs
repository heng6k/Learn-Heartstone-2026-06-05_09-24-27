...
namespace LearnHearthstone.Application.Services
{
    public static class MechanicCoverageReportService
    {
        public static MechanicCoverageReport CreateDefaultReport()
        {
            ...
            Add(report, "Quest/Trinket interactions", true, true, true, true, "Medium High", "Start-of-combat stacking, deathrattle repeats, shared Avenge events, summon modifiers, and opponent reward isolation have focused tests.");
            ...
            Add(report, "Timewarped content precision", true, true, true, true, "High", "High-impact combat minions and non-minion timewarped cards are covered by runtime handlers and focused tests, including Deathswarmer combat growth and Kil'rek demon reward precision slices.");
