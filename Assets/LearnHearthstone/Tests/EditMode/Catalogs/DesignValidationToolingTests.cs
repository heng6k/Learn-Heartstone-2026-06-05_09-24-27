...
namespace LearnHearthstone.Tests.EditMode
{
    public sealed class DesignValidationToolingTests
    {
        ...
        [Test]
        public void FullNextTurnScenario_StartsRecruitTurnAfterCombatReturn()
        {
            ...
            Assert.AreEqual(7, service.State.PendingTurnStartRound);
            ...
            messages = service.State.Player.Tavern.RecruitLog.Select(entry => entry.Message).ToList();
            startIndex = messages.FindIndex(message => message != null && message.Contains("Turn 7 started."));
        ...
        [Test]
        public void TimewarpedTurn_StartsRecruitTurnOnlyAfterVisitExit()
        {
            var service = MatchService.CreateWithDefaultCatalog(
                12345,
                new InMemoryTestScenarioRepository(),
